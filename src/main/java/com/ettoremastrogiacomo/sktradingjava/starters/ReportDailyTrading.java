...
public class ReportDailyTrading {
    ...
    public static void main(String[] args) throws Exception {
        ...
        List<String> list=Database.getFilteredPortfolio(Optional.empty(), Optional.of(3000), Optional.of(.15), Optional.of(10), Optional.empty(), Optional.of(100000), Optional.empty());
        ...
        ptf.walkForwardTestSharpe(Optional.of(250), Optional.of(60), Optional.of(1000000L), Optional.of(10),Optional.of(true));
